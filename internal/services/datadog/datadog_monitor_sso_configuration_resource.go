	...
	resource := &pluginsdk.Resource{
		...
		Schema: map[string]*pluginsdk.Schema{
			"datadog_monitor_id": {
				...
				Required:     true,
				ForceNew:     true,
				ValidateFunc: datadogmonitorresources.ValidateMonitorID,
			},
...
func resourceDatadogSingleSignOnConfigurationsCreate(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	monitorId, err := datadogmonitorresources.ParseMonitorID(d.Get("datadog_monitor_id").(string))
	if err != nil {
		return err
	}
...
func resourceDatadogSingleSignOnConfigurationsRead(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	d.Set("datadog_monitor_id", datadogmonitorresources.NewMonitorID(id.SubscriptionId, id.ResourceGroupName, id.MonitorName).ID())
