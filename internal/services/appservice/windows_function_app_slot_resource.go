		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			siteEnvelope := webapps.Site{
				...
				Properties: &webapps.SiteProperties{
					...
					OutboundVnetRouting:       helpers.ExpandOutboundVnetRouting(siteConfig.VnetRouteAllEnabled, pointer.To(functionAppSlot.VirtualNetworkBackupRestoreEnabled), pointer.To(functionAppSlot.VnetImagePullEnabled)),
