...
func TestAccPrivateEndpoint_billingSkuUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_private_endpoint", "test")
	r := PrivateEndpointResource{}
...
func (r PrivateEndpointResource) withBillingSku(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
