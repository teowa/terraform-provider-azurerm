...
var ValidateWebApplicationFirewallPolicyManagedRuleOverrideGroupName = validation.StringInSlice([]string{
	"BadBots",
	"crs_20_protocol_violations",
	"crs_21_protocol_anomalies",
	"crs_23_request_limits",
...
var ValidateWebApplicationFirewallPolicyManagedRuleSetType = validation.StringInSlice([]string{
	"OWASP",
	"Microsoft_BotManagerRuleSet",
	"Microsoft_DefaultRuleSet",
