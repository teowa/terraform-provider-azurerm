...
type Client struct {
	*network_2025_01_01.Client
	...
	// Private Endpoints and Private DNS Zone Groups are pinned to `2025-07-01` ahead of the wider Network umbrella client
	PrivateDnsZoneGroupsClient *privatednszonegroups.PrivateDnsZoneGroupsClient
	PrivateEndpointsClient     *privateendpoints.PrivateEndpointsClient
}
