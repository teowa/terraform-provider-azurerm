...
type Client struct {
	*network_2025_01_01.Client
	...
	// ApplicationGateways is pinned to `2025-07-01` to support `client_auth_configuration.verify_client_auth_mode` on SSL Profiles, overriding the `2025-01-01` client embedded above
