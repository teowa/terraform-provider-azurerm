...
func resourceMsSqlServerUpdate(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	if _, ok := d.GetOk("administrator_login_password"); ok && expandMsSqlServerAADOnlyAuthentication(d.Get("azuread_administrator").([]interface{})) && d.HasChange("administrator_login_password") {
