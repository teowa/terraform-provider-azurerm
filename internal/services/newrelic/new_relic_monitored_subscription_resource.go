...
var _ sdk.Resource = NewRelicMonitoredSubscriptionResource{}
...
func (r NewRelicMonitoredSubscriptionResource) Create() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			client := metadata.Client.NewRelic.Client.MonitoredSubscriptions
...
func (r NewRelicMonitoredSubscriptionResource) Read() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			monitoredId := monitoredsubscriptions.NewMonitorID(id.SubscriptionId, id.ResourceGroup, id.MonitorName)

			resp, err := client.Get(ctx, monitoredId)
			if err != nil {
...
func (r NewRelicMonitoredSubscriptionResource) Delete() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			if err = client.DeleteThenPoll(ctx, monitoredId); err != nil {
