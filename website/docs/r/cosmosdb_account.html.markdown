...
~> **Note:** The `virtual_network_rule` property has been deprecated in favour of the `virtual_network_subnet_ids` and `virtual_network_subnet_ids_ignore_missing_vnet_service_endpoint` properties and will be removed in v6.0 of the AzureRM Provider.
