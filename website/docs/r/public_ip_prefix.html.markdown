...
-> **Note:** Upgrading `sku` from `Standard` to `StandardV2` can be done in-place. Downgrading `sku`, or changing it to any other value, forces a new resource to be created.
