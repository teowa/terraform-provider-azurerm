...
description: |-
  Manages a Azure Native New Relic Monitored Subscription.
---
...
* `monitor_id` - (Required) Specifies the ID of the New Relic Monitor this Tag Rule should be created within. Changing this forces a new Azure Native New Relic Monitored Subscription to be created.
