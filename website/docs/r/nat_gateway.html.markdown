...
* `source_virtual_network_id` - (Optional) The ID of the Virtual Network which should be associated with this NAT Gateway. Changing this forces a new resource to be created.
