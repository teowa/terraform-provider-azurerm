...
* The deprecated `virtual_network_rule` property has been removed in favour of the `virtual_network_subnet_ids` and `virtual_network_subnet_ids_ignore_missing_vnet_service_endpoint` properties.
